...
public class Lista
{
	...
	///////Resposta questão 1: Complexidade O(n) pois toda a lista será percorrida para se obter o seu tamanho.
	//Uma forma de melhorar o metodo seria criano uma chamada a ele sempre que um novo elemento fosse adicionado ou removido, para isso teriamos que adicionar um novo parametro a classe lista que guardaria seu tamanho atual.
